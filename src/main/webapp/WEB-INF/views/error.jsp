...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">ERROR</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/portfolio.png" alt="..." />
                <!-- Masthead Heading-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0" href="/">사진을 인식할 수 없습니다. 다른 사진으로 다시 시도해주세요.</p>
                <p></p><!-- 홈으로 돌아가기 -->
                <a href="/" style="color: black;">홈으로 돌아가기</a>
            </div>
        </header>
        <!-- Portfolio Section-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            보내주신 문의 사항은 주기적으로 검토 후에 따로 답변을 드리지 않고 업데이트할 계획입니다:)
                        </p>
                    </div>
                </div>
            </div>
